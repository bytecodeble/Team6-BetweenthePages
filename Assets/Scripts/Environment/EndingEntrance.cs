        ...
        private void OnTriggerEnter2D(Collider2D other)
        {
            ...
            if (ScreenFader.Instance != null)
            {
                ScreenFader.Instance.StartCoroutine(
                    ScreenFader.Instance.FadeToSceneCoroutine(
                        other.gameObject,
                        endingSceneName,
                        fadeDuration,
                        destroyPlayer
            ...
            {
                Debug.LogWarning("[EndingEntrance] ScreenFader not found! Forcing scene load.");
                SceneManager.LoadSceneAsync(endingSceneName, LoadSceneMode.Single);
            }
        }
